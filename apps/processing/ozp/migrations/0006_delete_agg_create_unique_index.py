...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ozp', '0005_add_timeslots_delete_unique'),
    ]

    operations = [
        migrations.RunSQL("""
        	DELETE FROM ozp_observation_related_observations 
				WHERE from_observation_id IN (
				    SELECT id FROM ozp_observation WHERE procedure_id IN (
        ...
        """),
        migrations.RunSQL("""
        	DELETE FROM ozp_observation WHERE procedure_id IN (
			    SELECT id FROM common_process WHERE name_id IN (
			        'apps.common.aggregate.sum_total', 
			        'apps.common.aggregate.circle_mean', 
			        'apps.common.aggregate.arithmetic_mean', 
        ...
        """),
        migrations.RunSQL("""
           	CREATE UNIQUE INDEX ozp_observation_uniq ON ozp_observation
			    (
