# Generated by Django 2.0.2 on 2018-03-23 08:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Type of an event.', max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(editable=False, help_text='Type of an event.', on_delete=django.db.models.deletion.DO_NOTHING, related_name='rsd_category', to='rsd.EventCategory')),
                ...
                ('result', models.ForeignKey(editable=False, help_text='Admin units of the event', on_delete=django.db.models.deletion.DO_NOTHING, related_name='rsd_result', to='rsd.EventExtent')),
            ],
        ),
